...
export default function Noise() {
  ...
  function randomize() {
    ...
    setFrequency(Number(random.toFixed(2)));
  }
  ...
  function download() {
    ...
    link.href = `data:image/svg+xml;base64,${Buffer.from(
      ...
      <div className={styles.wrapper}>
        <div className={styles.top}>
          <div className={styles.controls}>
            <button className={styles.button} onClick={randomize.bind(this)}>
              Randomize
            </button>
            <input
              type="range"
          ...
          <button className={styles.button} onClick={download.bind(this)}>
            Download
          </button>
        </div>
        <svg
