...
class MD {
    ...
    addBold(content: string) {
        if (content.includes('_')) {
            ...
            this._add(
                this._wrap(content, "__")
            );
        }
        else {
            this._add(
                this._wrapTag(content, "bold")
            );
        }
        return this
    }
    ...
    addItalic(content: string) {
        if (content.includes('_')) {
            ...
            this._add(
                this._wrap(content, "_")
            )
        }
        else {
            this._add(
                this._wrapTag(content, "italics")
            );
        }
        return this
    }
    ...
    addCode(content: string) {
        this._add(
            this._addBackSlash(
                this._wrap(this._addBackSlash(content), "`")
            )
        )
        return this
    }
...
class MDTable extends MD {
    ...
    addRow(...row: string[]) {
        if (!this._hasRows) { this._hasRows = true }
